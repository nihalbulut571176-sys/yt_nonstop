...
def main() -> None:
    ...
    for item in package_items:
        ...
        item["shot_type"] = draft.get("shot_type", item.get("shot_type"))
        item["transition_in"] = draft.get("transition_in", item.get("transition_in"))
        item["transition_out"] = draft.get("transition_out", item.get("transition_out"))
        item["film_block_id"] = draft.get("film_block_id", item.get("film_block_id"))
        ...
        item["visualized_claim"] = draft.get("visualized_claim", item.get("visualized_claim", ""))
        item["must_show"] = draft.get("must_show", item.get("must_show", []))
        ...
        if scene:
            ...
            scene["shot_type"] = draft.get("shot_type", scene.get("shot_type"))
            scene["transition_in"] = draft.get("transition_in", scene.get("transition_in"))
            scene["transition_out"] = draft.get("transition_out", scene.get("transition_out"))
            scene["film_block_id"] = draft.get("film_block_id", scene.get("film_block_id"))
            ...
            scene["visualized_claim"] = draft.get("visualized_claim", scene.get("visualized_claim", ""))
            scene["must_show"] = draft.get("must_show", scene.get("must_show", []))
