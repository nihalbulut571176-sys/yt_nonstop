        ...
        context_pack.append(
            {
                ...
                "visualized_claim": item.get("visualized_claim", scene.get("visualized_claim", beat.get("spoken_claim", ""))),
                ...
                "must_show": item.get("must_show", scene.get("must_show", beat.get("must_visualize", []))),
                "shot_id": item.get("shot_id", scene.get("shot_id")),
                "generation_mode": item.get("generation_mode", scene.get("generation_mode")),
                "source_shot_id": item.get("source_shot_id", scene.get("source_shot_id")),
                "shot_type": item.get("shot_type", scene.get("shot_type")),
                "film_block_id": item.get("film_block_id", scene.get("film_block_id")),
                "camera_rule": item.get("camera_rule", scene.get("camera")),
                "style_rule": item.get("style_rule", project["prompts"].get("global_style_summary") or project["prompts"].get("style_preset")),
                "transition_in": item.get("transition_in", scene.get("transition_in", "cut")),
                "transition_out": item.get("transition_out", scene.get("transition_out", "cut_on_phrase_end")),
                "beat_priority": item.get("beat_priority", scene.get("beat_priority", beat.get("visual_priority", "low"))),
                "key_beat": bool(item.get("key_beat", scene.get("key_beat", False))),
                "variant_count": int(item.get("variant_count", scene.get("variant_count", 1)) or 1),
